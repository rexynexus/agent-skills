...
| Skill | Description |
|-------|-------------|
| [artifacts](skills/artifacts/) | Update standard Obsidian project artifact files (plan.md, design.md, problems.md, log.md, resources.md) based on the current session's work. Also manages Claude Code settings snapshots (`/artifacts settings backup\|restore\|audit`) |
